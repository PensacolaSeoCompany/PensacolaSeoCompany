<?php
// Handle form submission (configure SMTP details)
...
<head>
    ...
    <title>Test Page with Appointment Button</title>
    <!-- Bootstrap CSS -->
...
<div class="container mt-5">
    <h1 class="text-center mb-4">Test the Appointment Button</h1>
                ...
                <div class="modal-body">
                    <form method="POST" action="">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="message" name="message" rows="